...
public class ViewingFigures 
{
	...
	public static void main(String[] args)
	{
		...
		// Step1 - remove duplicates values from viewData
		
		viewData = viewData.distinct();
		
		
		//Step2 - get the course Id's into the RDD
		...
		//Step3 - Loose the chapter Id
		JavaPairRDD<Tuple2<Integer,Integer>,Long> newRdd = joinedRdd.mapToPair(row -> {
		...
		//step4 - count how many views per chapter
		newRdd = newRdd.reduceByKey((value1,value2)-> value1 + value2);
		
		
		//step5 - remove userId
		JavaPairRDD <Integer, Long> step5 = newRdd.mapToPair(row -> new Tuple2<Integer, Long>(row._1._2,row._2));
		
		
		//step6 - add in the total chapter count
